		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD OBAAMA BOT*',
					...
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de obama. Registre-se para fazer amizade com o bot obamita por meio, \n\nCommand : ${prefix}daftar nome|idade\nExemplo : ${prefix}daftar obama|16\n\n──「 Obamita BOT 」──`,
			...
			const mod = [ownerNumber,"553899815548@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["553899815548@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["553899815548@s.whatsapp.net"]//ubah nomor lo
			const premium = ["553899815548@s.whatsapp.net","5565@s.whatsapp.net","566@s.whatsapp.net","666@s.whatsapp.net","46@s.whatsapp.net","8778@s.whatsapp.net","5581889@s.whatsapp.net","554@s.whatsapp.net","65656@s.whatsapp.net"]
  ...
  conn.sendMessage(id, hasil, MessageType.text); 
	...
	if (messagesC.includes("bosta")){
		...
		if (messagesC.includes("bot")){
			...
			client.updatePresence(from, Presence.composing)
			data = fs.readFileSync('./src/obamajokes.js');
...
break
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOO obama BOT 👑* 」\n\`\`\``
					no = 0
...
// recursos anime, random @obama domina vida
          ...
          reply('Espere..')
			    ...
			    case 'dono':
                    ...
                    client.sendMessage(from, 'Meu dono é esse gasoso aí tal de "obama"🙄,',MessageType.text, { quoted: mek} )
                    break
                case 'fitnah':	
				case 'fake':          
                    if (!isGroup) return reply(mess.only.group)
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT obama ✨* 」\n*│+ wa.me/556993733829*╰──────*「 *obama* 」*────*\n\n*_SE QUER SER ADMIN DO BOT obama_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				if (!isUser) return reply(mess.only.userB)
					...
					client.sendMessage(from, sa, image, { quoted: mek, caption: '*╭────*「 *PREMIUM USER👑* 」\n*│+ wa.me/553899815548*╰──────*「 * obama* 」*────*\n\n*_SE QUER SER UM USUÁRIO PREMIUM DO obama BOT_*\n*_Ketik #daftarvip*' })
					break
					case 'cekmod': 
